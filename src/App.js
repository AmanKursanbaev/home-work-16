...
function App() {
	...
	return (
		<React.Fragment>
			<AuthContext.Provider value={{isLoggedIn: isLoggedIn, onLogout: logoutHandler,isOpen: isOpen, onToggle:toggle}}>
				<MainHeader 
					
				/>
				<main  style={ isOpen ? {height: '700px', backgroundColor: '#4e3c3c' } : {backgroundColor: "white"}}>
